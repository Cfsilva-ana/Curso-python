...
- **README.md** - Como instalar Python e configurar VS Code
- Extensões necessárias
- Configurações recomendadas

### 📁 Seção 3 - Fundamentos Python

#### 🎯 Aulas Principais (01-22):

| Aula | Tópico | Arquivo | Conceitos |
|------|--------|---------|----------|
| **01** | Introdução | `01_INTRODUCAO AO PYTHON.py` | Conceitos básicos, interpretador |
| **02** | Função print() | `02_FUNCAO print().py` | Exibir informações, parâmetros |
| **03** | Variáveis | `03_VARIÁVEIS.py` | Armazenamento, regras, boas práticas |
| **04** | Tipos de Dados | `04_TIPOS_DE_DADOS.py` | str, int, float, bool + exemplos |
| **05** | Tipagem Dinâmica | `05_TIPAGEM_DINAMICA.py` | Flexibilidade do Python |
...
| **14** | Entrada de Dados | `14_INPUT.py` | input(), conversões, validação |
| **15** | Condicionais | `15_CONDICIONAIS.py` | if/elif/else, fluxo do interpretador |
| **16** | Operadores | `16_OPERADORES.py` | Todos os tipos de operadores |
| **17** | Try/Except | `17_TRY_EXCEPT.py` | Tratamento avançado de erros |
| **18** | Operadores in/not in | `18_OPERADORES_IN_NOT_IN.py` | Verificação de conteúdo |
| **19** | Formatação Avançada | `19_FORMATACAO_AVANCADA.py` | Interpolação e alinhamento |
| **20** | Fatiamento de Strings | `20_FATIAMENTO_STRINGS.py` | Índices, slicing, extração |
...
### Fundamentos Básicos (01-08)
- [ ] Aula 01 - Introdução ao Python
- [ ] Aula 02 - Função print()
- [ ] Aula 03 - Variáveis
- [ ] Aula 04 - Tipos de Dados
- [ ] Aula 05 - Tipagem Dinâmica
- [ ] Aula 06 - Conversão de Tipos
- [ ] Aula 07 - Valores Booleanos
- [ ] Aula 08 - Tratamento de Erros Básico

### Operações e Formatação (09-13)
- [ ] Aula 09 - Operadores Aritméticos
- [ ] Aula 10 - Concatenação e Repetição
- [ ] Aula 11 - Precedência dos Operadores
- [ ] Aula 12 - F-strings
- [ ] Aula 13 - Método format()

### Estruturas de Controle e Avançado (14-22)
- [ ] Aula 14 - Entrada de Dados (input)
- [ ] Aula 15 - Condicionais (if/elif/else)
- [ ] Aula 16 - Operadores Completos
- [ ] Aula 17 - Tratamento Avançado de Erros
- [ ] Aula 18 - Operadores in/not in
- [ ] Aula 19 - Formatação Avançada
- [ ] Aula 20 - Fatiamento de Strings
- [ ] Aula 21 - Loops While
- [ ] Aula 22 - Loops For
